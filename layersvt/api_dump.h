...
class ApiDumpInstance {
  public:
    inline ApiDumpInstance()
        : frame_count(0), thread_count(0), dump_settings(NULL) {
    ...
    inline uint64_t frameCount() const { return frame_count; }

    inline void nextFrame() { ++frame_count; }
